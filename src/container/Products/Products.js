...
class Products extends React.Component{
    constructor(props) {
      ...
      for(let product of this.props.products){
        ...
        product.power_max >= this.state.maxPowerValue[0] && product.power_max <= this.state.maxPowerValue[1] &&
        ...
        product.height_max >= this.state.heightValue[0] && product.height_max <= this.state.heightValue[1]
        ){
          res.push(product);
        }
      }
